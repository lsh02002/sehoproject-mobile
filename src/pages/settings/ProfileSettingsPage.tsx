  ...
  return (
    <Section>
      ...
      <TwoDiv>
        ...
        <TextInput name="email" title="이메일" data={email} setData={setEmail} />
      </TwoDiv>
      <TwoDiv>
        <PasswordInput name="password" title="비밀번호" data={password} setData={setPassword} />
        <DateInput title="생년월일" selected={birthday} setSelected={setBirthday} />
      </TwoDiv>
      <FooterBar>
